		...
		<div class="col-md-9 col-md-push-3">
			<!-- Get the directory data -->
			 <?php
			 	...
			 	echo do_shortcode('[ajax_load_more theme_repeater="shop.php" post_type="food-beverage" posts_per_page="9" scroll="false" images_loaded="true" button_label="+ Load More" button_loading_label="Loading More..." container_type="div"]');
			 ?>
		</div>
