...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<?php 
			if( get_field( 'video_type' ) == 'self_hosted_video' ) :
				
				echo do_shortcode( '[video src="'. get_field('self_hosted_video') .'"][/video]' );
						
			endif;
		?><!-- end of self hosted video -->
		
		<?php 
			if( get_field( 'video_type' ) == 'embed_code_video' ) :
							
				the_field('embed_code_video');
