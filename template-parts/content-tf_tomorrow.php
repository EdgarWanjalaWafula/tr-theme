...
<?php
	...
	if ( $query->have_posts() ) :
		...
		while ( $query->have_posts() ) : $query->the_post();
			...
			//Check the date tomorrow
			$get_tomorrows_date =  new DateTime( 'tomorrow' );
			$td_format = $get_tomorrows_date->format( 'Y-m-d' );
			$tomorrows_date = strtotime( $td_format );			
			...
			if ( ( $event_date == $tomorrows_date ) || ( $offer_expiry >= $tomorrows_date ) ):
