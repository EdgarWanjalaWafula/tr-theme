			...
			if (get_field('choose_your_ad_video_type') == 'video_ad_self_hosted_bg') {
				?>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 tile">
						<div class="trm-2">
							<video class="tr-masthead-video" autoplay loop muted poster="<?php the_post_thumbnail_url( 'center-top' ); ?>">
				...
				?>
					...
					<!-- Second Tile - Center Top -->
					<div class="col-md-6 col-sm-6 col-xs-12 tile">
						<div class="trm-2 <?php if( get_field('link') ) : ?>btn-link<?php endif; ?>">
							<video class="tr-masthead-video" autoplay loop muted poster="<?php the_post_thumbnail_url( 'center-top' ); ?>">
								<?php if( get_field('ad_mp4_version') ): ?>
									<source src="<?php the_field('ad_mp4_version'); ?>" type="video/mp4">
								<?php endif; ?>
				...
				?>
					...
					<div class="col-md-6 col-sm-6 col-xs-12 tile">
						...
						<div class="trm-2 <?php if( get_field('link') ) : ?>btn-link<?php endif; ?>" style="background-image: url(<?php the_post_thumbnail_url( 'center-top' ); ?>);">
