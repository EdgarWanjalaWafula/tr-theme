	...
	<div class="col-md-12">
		<header class="entry-header text-center">
			...
			<?php 
				...
				$term_list = wp_get_post_terms($post->ID, 'type-of-offers', array("fields" => "all"));
				...
				foreach($term_list as $term_single) {
					...
					?>
						...
						<a class="cat-name" href="<?php print get_term_link( $category_id, 'type-of-offers' ); ?>" alt="<?php echo $category_name; ?>" title="<?php echo $category_name; ?>" >
